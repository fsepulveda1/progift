...
@section('page_title','Pro-gift | '.$dataType->getTranslatedAttribute('display_name_plural'))
        ...
        <div class="row no-margin">
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-header bg-white border-0">
                        <div class="row no-margin align-items-center">
                            ...
                            <div class="col-sm-4 text-right">
                                ...
                                @can('edit', app($dataType->model_name))
                                    ...
                                    <!--
                                        <a href="{{ route('voyager.'.$dataType->slug.'.order') }}" class="btn btn-primary btn-sm btn-add-new">
                                    ...
                                    @foreach($dataType->browseRows as $row)
                                        ...
                                        @php
                                            if($row->field === "cotizacione_belongsto_client_relationship"){
                                                echo "<th nowrap='nowrap'>Rut Empresa</th>";
                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr @if($data->tipo == 'Web') class="warning" @endif>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                            <td @if($row->type == 'date' || $row->type == 'timestamp')nowrap="nowrap"@endif>
                                                    ...
                                                    @php
                                                        $fullComment = $shortComment = '';
                                                            if($row->field === "cotizacione_belongsto_client_relationship"){
                                                                ...
                                                                $model = app('App\\Client');
                                                                $query = $model::where('id',$relationshipData->{'client_id'})->first();
                                                                echo "<td nowrap='nowrap'>".$query->rut."</td>";
                                                                echo "<td>".$query->contacto."</td>";
                                                    ...
                                                    @else
                                                        @php
                                                            if($row->field === "estado"){
                                                                ...
                                                                if($est == "cotizaciones"){
                                                                    if($data->{$row->field} == 0){
                                                                        echo '<span class="label label-danger">SIN ENVIAR</span>';
                                                                    }else{
