								...
								<div class="card-body">
									<div class="row">
										<div class="col-sm-9">
											...
											<span class="h2 font-weight-bold mb-0 "><strong class="money">{{number_format($productos, 0, ',', '.')}}</strong></span>
										</div>
										<div class="col-sm-2">
                                    ...
                                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> {{number_format($productoshoy, 0, ',', '.')}}</span>
										<span class="text-nowrap">Productos en los últimos 30 días</span>
									</p>
								</div>
							</div>
						</div>
							...
							<div class="card card-stats mb-4 mb-xl-0">
								<div class="card-body">
									<div class="row">
                                        ...
                                        <span class="h2 font-weight-bold mb-0">{{number_format($clientes, 0, ',', '.')}}</span>
										</div>
										<div class="col-sm-2">
									...
									<p class="mt-3 mb-0 text-muted text-sm">
                                    <span class="text-danger mr-2"><i class="fas fa-arrow-up"></i> {{number_format($clienteshoy, 0, ',', '.')}}</span>
										<span class="text-nowrap">Clientes en los últimos 30 días</span>
									</p>
								</div>
							</div>
						</div>
							...
							<div class="card card-stats mb-4 mb-xl-0">
								<div class="card-body">
									<div class="row">
                                        ...
                                        <span class="h2 font-weight-bold mb-0">{{number_format($cotizaciones, 0, ',', '.')}}</span>
										</div>
										<div class="col-sm-2">
									...
									<p class="mt-3 mb-0 text-muted text-sm">
                                    <span class="text-warning mr-2"><i class="fas fa-arrow-up"></i> {{number_format($cotizacioneshoy, 0, ',', '.')}}</span>
										<span class="text-nowrap">Cotizaciones en los últimos 7 días </span>
									</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="card card-stats mb-4 mb-xl-0">
								<div class="card-body">
									<div class="row">
										<div class="col-sm-9">
											<h5 class="card-title text-uppercase text-muted mb-0">Total Cotizaciones</h5>
                                        <span class="h2 font-weight-bold mb-0 "><strong class="money">${{number_format($total, 0, ',', '.')}}</strong></span>
										</div>
										<div class="col-sm-2">
									...
									<p class="mt-3 mb-0 text-muted text-sm">
										...
										<span class="text-nowrap">Total en el sistema</span>
									</p>
								</div>
							</div>
						</div>
