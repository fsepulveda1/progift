						...
						<div class="card-header bg-white border-0">
							<div class="row align-items-center">
								...
								<div class="col-4 text-right">
									<a href="{{ url('admin/cotizaciones') }}" class="btn btn-sm btn-success">Listar Todas</a>
								</div>
							</div>
						</div>
						<div class="card-body">
							<form action="{{ route('admin.cotiza') }}" method="POST">
									...
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" name="empresa" readonly="readonly" class="form-control form-control-alternative" placeholder="Lata Digital" value="{{$cliente->nombre}}" required>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" name="nombre_cliente" readonly="readonly" class="form-control form-control-alternative" placeholder="Javier Sepulveda" value="{{$cliente->contacto}}" required>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
												<label class="form-control-label" for="input-email">Email</label>
												<input type="email" name="email" readonly="readonly" class="form-control form-control-alternative" value="{{$cliente->email}}" placeholder="jesse@example.com" required>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<input type="text" name="validez" class="form-control form-control-alternative" placeholder="10" value="{{$cotizacion->validez}}" required>
											</div>
										</div>
										<div class="col-lg-3" style="display: none;">
											<div class="form-group">
												...
												<select class="form-control form-control-alternative" name="tipo" id="tipo" required>
													...
													<option value="Normal" <?php if($cotizacion->tipo == "Normal"){echo "selected";} ?>>Normal</option>
													<option value="Descuento" <?php if($cotizacion->tipo == "Descuento"){echo "selected";} ?>>Descuento</option>
												</select>
											</div>
										</div>
									</div>
								...
								@php
									$detalle = json_decode($cotizacion->detalle, true);
									//dd($detalle);
								@endphp
										...
										<div class="row">
											...
											<div class="col-lg-1">
												<div class="form-group">
													...
													<input type="text" name="producto[{{$cnt}}][color]" id="color" required class="form-control form-control-alternative" value="{{$d['color']}}">
												</div>
											</div>
											<div class="col-lg-1">
												<div class="form-group">
													<label class="form-control-label" for="exampleFormControlSelect1">Impresión</label>
													<input type="text" name="producto[{{$cnt}}][impresion]" id="impresion" required class="form-control form-control-alternative" value="{{$d['imprenta']}}">
												</div>
											</div>
											<div class="col-lg-1">
											...
											<div class="col-lg-1">
												<div class="form-group">
													...
													<input type="number" value="{{$d['suma'][0]}}" name="producto[{{$cnt}}][suma][]" id="precio_suma" class="form-control form-control-alternative money precio_suma" placeholder="0" required>
												</div>
											</div>
											<div class="col-lg-1">
												<div class="form-group">
															...
															<div class="row" id="{{$num}}">
																...
																<div class="col-lg-2">
																	<div class="form-group">
																		...
																		<input type="number" value="{{$d['suma'][$key]}}" name="producto[{{$cnt}}][suma][]" id="precio_suma" class="form-control form-control-alternative money precio_suma" placeholder="0" required="" />
																	</div>
																</div>
																<div class="col-lg-1">
																	<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<input type="number" id="total" name="total" value="{{$cotizacion->total}}" class="form-control form-control-alternative money total" placeholder="0">
											</div>
										</div>
									</div>
								</div>
									...
									'<div class="row" id="'+i+'">'+
										'<div class="col-lg-6">'+
											...
											'<div class="col-lg-1">'+
												'<div class="form-group">'+
													'<label for="example-search-input" class="form-control-label">Cantidad</label>'+
													'<input type="number" name="producto['+a+'][cantidad][]" id="cantidad" class="form-control form-control-alternative cantidad" placeholder="0" required>'+
													'</div>'+
													'</div>'+
													'<div class="col-lg-2">'+
														'<div class="form-group">'+
															'<input type="hidden" id="precio_unitario" class="precio_unitario"/>'+
															'<label for="example-search-input" class="form-control-label">Valor Unitario</label>'+
															'<input type="number" name="producto['+a+'][precio][]" id="precio" class="form-control form-control-alternative money precio p_'+i+'" placeholder="0" required>'+
															'</div>'+
															'</div>'+
															'<div class="col-lg-2">'+
																'<div class="form-group">'+
																	'<label for="example-search-input" class="form-control-label">Valor total</label>'+
																	'<input type="number" name="producto['+a+'][suma][]" id="precio_suma" class="form-control form-control-alternative money precio_suma" placeholder="0" required>'+
																	'</div>'+
																	'</div>'+
																	'<div class="col-lg-1">'+
																		'<div class="form-group">'+
